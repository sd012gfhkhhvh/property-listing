		...
		<nav id="sidebar" class="bg-white sidebar sticky-top shadow-sm" style="width: 250px; height: 100vh; overflow-y: auto;">
			<div class="position-sticky">
				...
				<ul class="nav flex-column py-3">
					<li class="nav-item">
						<a class="nav-link active py-3 px-4 d-flex align-items-center" href="index.php">
				...
				<div class="container mt-4">
					...
					<div class="accordion mb-4" id="accordionExample">
						...
						<div class="accordion-item border-0 shadow-sm mb-3">
							...
							foreach ($properties as $property) {
								if ($property['ufCrm83PropertyType'] === 'residential') {
									...
									$residentialFinder += ($property['ufCrm83PfEnable'] === 'Y') ? 1 : 0;
									$residentialBayut += ($property['ufCrm83BayutEnable'] === 'Y') ? 1 : 0;
									$residentialWebsite += ($property['ufCrm83WebsiteEnable'] === 'Y') ? 1 : 0;
								} elseif ($property['ufCrm83PropertyType'] === 'commercial') {
									// Count Commercial properties by source
									$commercialSales += ($property['sourceId'] === 'CALL') ? 1 : 0;
									$commercialRent += ($property['sourceId'] === 'RENT') ? 1 : 0;
									$commercialFinder += ($property['ufCrm83PfEnable'] === 'Y') ? 1 : 0;
									$commercialBayut += ($property['ufCrm83BayutEnable'] === 'Y') ? 1 : 0;
									$commercialWebsite += ($property['ufCrm83WebsiteEnable'] === 'Y') ? 1 : 0;
								}
							}
							?>
