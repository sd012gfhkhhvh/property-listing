		...
		<form action="publishing.php" method="POST" enctype="multipart/form-data">
				...
				<div class="row p-3 bg-light rounded border">
					<div class="col-md-6 mb-3">
						...
						<div class="mb-3">
							...
							<input type="text" id="propertyLatitude" name="propertyLatitude" class="form-control">
						</div>
						<div class="mb-3">
							<label for="propertyLongitude" class="form-label">Longitude</label>
							<input type="text" id="propertyLongitude" name="propertyLongitude" class="form-control">
						</div>
					</div>
					<div class="col-md-6 mb-3">
			...
			<div class="container mt-5">
				<div class="bg-light p-4 rounded border">
					...
					<div class="text-center mb-3">
						<input type="file" name="floorPlan" id="floorPlan" class="d-none">
			...
			<div class="d-flex justify-content-between align-items-center mt-3 mb-3">
				...
				<div class="d-flex gap-3">
					...
					<button type="submit" onclick="location.href='publishing.php'" class="btn btn-primary">
