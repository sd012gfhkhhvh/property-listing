...
if ($data) {
    $response = CRest::call('crm.item.add', [
        'entityTypeId' => LANDLORDS_ENTITY_TYPE_ID,
        'fields' => [
            'ufCrm91LandlordName' => $data['name'],
            'ufCrm91LandlordEmail' => $data['email'],
            'ufCrm91LandlordMobile' => $data['mobile'],
        ]
    ]);
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody id="locationTableBody">
                            <?php foreach ($landlords as $landlord) : ?>
                                <tr>
                                    <td><?= $landlord['id'] ?></td>
                                    <td><?= $landlord['ufCrm91LandlordName'] ?></td>
                                    <td><?= $landlord['ufCrm91LandlordEmail'] ?></td>
                                    <td><?= $landlord['ufCrm91LandlordMobile'] ?></td>
                                    <td>
