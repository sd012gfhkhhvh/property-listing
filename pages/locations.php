...
if ($data) {
    ...
    $response = CRest::call('crm.item.add', [
        'entityTypeId' => LOCATIONS_ENTITY_TYPE_ID,
        'fields' => [
            'ufCrm87Location' => $data['location'],
            'ufCrm87City' => $location['city'],
            'ufCrm87Community' => $location['community'],
            'ufCrm87SubCommunity' => $location['sub_community'],
            'ufCrm87Building' => $location['building'],
        ]
    ]);
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody id="locationTableBody">
                            <?php foreach ($locations as $location) : ?>
                                <tr>
                                    <td><?= $location['id'] ?></td>
                                    <td><?= $location['ufCrm87Location'] ?></td>
                                    <td>
